...
class DataTransformation:
    ...
    def get_data_tranformer_objects(self):
    ...
    def initiate_data_transformation(self):
        ...
        logging.info("Entered initiate data transformation mathod of data tranformation class")
        ...
        try:
            ...
            X_train_scaled = preprocessor.fit_tranform(X_train)
            ...
            train_arr = np.c[X_train_scaled , np.array(y_tarin)]
